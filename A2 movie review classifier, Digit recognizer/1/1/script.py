...
def calculateProbability(label, testIth, laplace):
    ...
    for word in testIth.keys():
        if word in vocabulary:
            ...
            # p = (laplace + occInLabel) / (wordsInLabel + (laplace * vocab_size) )
...
if __name__ == "__main__":
    ...
    t1 = time.time()
    print("Prediction time = ", t1 - t0)
    print("Writing Predicitions to Output File")
    ...
    # print("Random guess prediction accuracy = ", randomPrediction(testY, 100))
